...
def generate_plots_comparison(outputfile1_case1,outputfile2_case1,outputfile3_case1,outputfile4_case1, outputfile5_case1,  start_index, plot_days_data, plot_days_simulation, smooth_days, sub_dir, start_offset):
    ...
    district_simulation_4_case1 = prepare_district_simulation_plots_susceptible(outputfile4_case1,plot_days_simulation)

    district_simulation_5_case1 = prepare_district_simulation_plots_susceptible(outputfile5_case1,plot_days_simulation)
    ...
    plt.grid(True)
    plt.ylabel('Susceptible Fraction')
    plt.title('Karnataka -- Susceptibles') 
    plt.legend()
    plt.ylim(0,1)
