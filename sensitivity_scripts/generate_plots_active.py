...
def generate_plots_comparison(outputfile1_case1,outputfile2_case1,outputfile3_case1,  start_index, plot_days_data, plot_days_simulation, smooth_days, sub_dir, start_offset):
    ...
    plt.title('Karnataka -- Active cases  ('+mobility_names[mobility_case]+')')  
    plt.legend()
...
for i in range(0,4):
    for j in range(0,3):
        ...
        generate_plots_comparison(output1_case1,output2_case1,output3_case1, 204, 450, 450, 7, 'active_plots', 20)
